...
class TestGuessDatetimeFormat(tm.TestCase):
    def test_guess_datetime_format_with_parseable_formats(self):
        ...
        dt_formats = [
            '%Y-%m-%d',             # 2011-12-30
            '%d-%m-%Y',             # 30-12-2011
            '%Y-%m-%d %H:%M:%S',    # 2011-12-30 00:00:00
            '%Y-%m-%dT%H:%M:%S',    # 2011-12-30T00:00:00
            '%Y-%m-%d %H:%M:%S.%f', # 2011-12-30 00:00:00.000000
            '%d/%b/%Y %H:%M:%S',    # 30/Dec/2011 00:00:00
            '%d/%B/%Y'              # 30/December/2011
        ]
    ...
    def test_guess_datetime_format_with_for_array(self):
